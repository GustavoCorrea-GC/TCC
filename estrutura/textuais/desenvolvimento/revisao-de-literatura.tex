...
Aqui vou explanar um pouco sobre o protocolo IP
...
Assim pela aplicação é possível gerenciar os arquivos e diretórios, como é ilustrado da \autoref{FatFS2}. As principais funções fornecidas pela FatFs para a aplicação são \cite{FATFS}:
