...
Esse trabalho tem como objetivo geral o desenvolvimento de um sistema de atualização  de \textit{firmwares} \textit{Over The Air} para dispositivos IoT baseado nas bibliotecas FatFs, LwIP e Mbed TLS. 
