...
% DADOS DO TRABALHO--------------------------------------------------------------------------------------
\titulo{Sistema de atualização de \textit{firmware} \textit{Over-The-Air} para dispositivos de IoT baseado nas bibliotecas LwIP, Mbed TLS e FatFs}
\titleabstract{Over-The-Air firmware update system for IoT devices based on LwIP, Mbed TLS and FatFs libraries}
