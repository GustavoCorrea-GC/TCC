...
% DADOS DO TRABALHO--------------------------------------------------------------------------------------
\titulo{Sistema \textit{open-source} para a atualização de \textit{firmware} \textit{Over-The-Air} para dispositivos de IoT baseado nas bibliotecas LwIP, Mbed TLS e FatFs}
\titleabstract{Open-Source system for firmware OTA (Over-The-Air) update based on the libraries LwIP, Mbed TLS and FatFS}
